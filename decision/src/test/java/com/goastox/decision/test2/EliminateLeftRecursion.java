...
public class EliminateLeftRecursion {
    ...
    public static void main(String[] args) {
        EliminateLeftRecursion eliminateLeftRecursion = new EliminateLeftRecursion("/Users/konghanghang/commander/decision/src/test/java/com/goastox/decision/test2/input.txt");
